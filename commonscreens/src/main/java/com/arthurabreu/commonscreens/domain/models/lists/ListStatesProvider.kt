...
import com.arthurabreu.commonscreens.domain.data.AllListsState
import com.arthurabreu.commonscreens.domain.data.ListDividerStyle
import com.arthurabreu.commonscreens.domain.data.ListItemData
import com.arthurabreu.commonscreens.domain.data.ListItemStyle
...
object ListStatesProvider {
    ...
    val vibrantBackgroundList: AllListsState = AllListsState(
        ...
        titlePadding = PaddingValues(16.dp),
        itemStyle = ListItemStyle(
            textColor = Color.White, // Texto branco para contraste
    ...
    val circularItemsList: AllListsState = AllListsState(
        items = List(3) { ListItemData(id="circ_$it", text = (it+1).toString(), description = "Opção") },
    ...
    val emphasizedTextList: AllListsState = AllListsState(
        ...
        titlePadding = PaddingValues(16.dp),
        itemStyle = ListItemStyle(
            textColor = Color.Red, // Cor de destaque para o texto
        ...
        dividerStyle = ListDividerStyle(showBelow = true, color = Color.LightGray)
    )
    ...
    val listWithoutAnyTitle: AllListsState = AllListsState(
        ...
        dividerStyle = ListDividerStyle(showBelow = true, color = Color.Gray)
    )
